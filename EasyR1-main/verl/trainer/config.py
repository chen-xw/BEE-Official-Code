...
class TrainerConfig:
    ...
    val_save_details: bool = False
    """save per-sample validation results (question, answer, output, correct) to Excel"""
    val_output_path: Optional[str] = None
    """path to save validation results Excel file, default: val_results.xlsx under save_checkpoint_path"""
