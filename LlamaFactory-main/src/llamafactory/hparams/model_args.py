...
from typing import Any, Literal, Self, Optional, List
...
class BaseModelArguments:
    ...
    ###### NEW #################
    new_tokens: Optional[bool] = field(
        default=None,
        metadata={"help": "Added tokens to be added into the tokenizer. Use commas to separate multiple tokens."},
    )
    nums_new_tokens: Optional[int] = field(
        default=1024,
        metadata={"help": "Added tokens to be added into the tokenizer. Use commas to separate multiple tokens."},
    )
    vq_token_ids: Optional[List[int]] = field(
        default=None,
        metadata={"help": "Whether or not to resize the tokenizer vocab and the embedding layers."},
    )
    ###### NEW #################
